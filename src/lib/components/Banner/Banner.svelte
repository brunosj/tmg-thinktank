...
<section>
	<div style="background-color: {bgColor}">
		<div class="layout grid grid-cols-1 items-center py-10 lg:grid-cols-2 lg:py-24">
			<div>
				<div
					class="text-blue-normal pt-5 pb-10 text-left text-2xl leading-tight font-extrabold lg:pt-0 lg:pb-0 lg:text-5xl"
				>
					...
					{#if item.fields.buttonText}
						<div class="flex pt-6 lg:pt-12">
							<a href={buttonUrl()} target="_blank">
								<p
									class="hover:bg-blue-normal/80 bg-blue-normal rounded-md p-3 text-base font-bold text-white duration-300 lg:text-xl"
								>
